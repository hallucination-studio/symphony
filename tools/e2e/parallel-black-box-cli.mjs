...
const PUBLIC_REASON_CODES = new Set([
  ...
  "external_linear_e2e_project_reset_input_invalid",
  "external_linear_e2e_project_reset_read_failed",
  "external_linear_e2e_project_reset_issue_read_failed",
  "external_linear_e2e_project_reset_issue_archive_failed",
  "external_linear_e2e_project_reset_issue_read_back_failed",
  "external_linear_e2e_project_reset_label_read_failed",
  "external_linear_e2e_project_reset_label_ownership_invalid",
  "external_linear_e2e_project_reset_label_mutation_failed",
  "external_linear_e2e_project_reset_label_read_back_failed",
  ...
  "parallel_black_box_e2e_project_reset_unavailable",
  "parallel_black_box_e2e_project_reset_invalid",
  "parallel_black_box_e2e_project_reset_project_mismatch",
]);
