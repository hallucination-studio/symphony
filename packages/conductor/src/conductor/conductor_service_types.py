...
class CoordinationResult(dict[str, Any]):
    def __init__(
        ...
        *,
        ...
        pipeline_attempts_started: int = 0,
        pipeline_results_applied: int = 0,
        pipeline_integrations_processed: int = 0,
        pipeline_leases_reclaimed: int = 0,
        pipeline_timeouts: int = 0,
        pipeline_crash_retries: int = 0,
        pipeline_crash_failures: int = 0,
        pipeline_human_actions_created: int = 0,
        pipeline_human_actions_completed: int = 0,
        pipeline_human_actions_missing_response: int = 0,
        pipeline_human_actions_failed: int = 0,
        pipeline_runtime_waits_observed: int = 0,
        linear_pipeline_ingestions: int = 0,
        linear_pipeline_projections: int = 0,
        dispatchable: int = 0,
        ...
        super().__init__(
            ...
            pipeline_crash_retries=pipeline_crash_retries,
            ...
            pipeline_human_actions_missing_response=pipeline_human_actions_missing_response,
            pipeline_human_actions_failed=pipeline_human_actions_failed,
