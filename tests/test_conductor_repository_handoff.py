...
from conductor.conductor_linear_direct import ManagedRunLinearProxy
...
async def test_conductor_linear_proxy_ensures_blocks_relation() -> None:
    ...
    proxy = ManagedRunLinearProxy(endpoint="https://linear.test/graphql", api_key="token", transport=transport)  # type: ignore[arg-type]
