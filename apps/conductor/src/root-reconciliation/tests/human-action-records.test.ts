...
test("Root directive records round-trip the accepted directive and correlation", () => {
  const directive = {
    ...
    modelTurn: {
      turnRecordId: "root-1:turn-1", role: "root_reconciler" as const, rootIssueId: "root-1",
      reconcilerSessionId: "session-1", reconcilerTurnId: "turn-1", invocationState: "confirmed" as const,
      model: "gpt", outcome: "directive_accepted" as const,
      usage: { status: "unavailable" as const, reason: "provider_omitted" as const }, terminalAt: "2026-07-23T00:00:01Z",
    },
