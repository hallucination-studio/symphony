...
export type RootTimelineEvent = TimelineEventBase & {
  timelineKind: "root";
  kind:
    | "root_claimed"
...
export type CycleTimelineEvent = TimelineEventBase & {
  timelineKind: "cycle";
  cycleIssueId: string;
  kind:
...
export type WorkflowTimelineEvent = RootTimelineEvent | CycleTimelineEvent;
